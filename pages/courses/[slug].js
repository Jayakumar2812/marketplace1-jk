      ...
      { courseState &&
        ...
        courseState ==="purchased" &&
          <Message type="warning">
            Course is purchased and waiting for the  activation. Process can take upto 24 hours.
            <i className="block font-normal"> In case of any questions, please contact jayakumargowtham2812@gmail.com </i>
          </Message>
        } 
        {
        courseState ==="activated" &&
          <Message type="success">
            Enjoy the course,Happy watching!. 
          </Message>
        } 
        {
